...
Nesta edição, reunimos novidades que ajudam a melhorar a produtividade e facilitar o acesso aos produtos internos. Confira o que mudou e veja como utilizar cada novidade.

## 🚀 Novidades da semana

### ⭐ Central de Solicitações 2.0

- **O que é:** Nova versão da central interna para abertura e acompanhamento de solicitações de suporte.
- **Por que isso importa:** Centraliza as solicitações em um único local e facilita o acompanhamento do status de cada atendimento.
...
- A Central de Solicitações 2.0 centraliza a abertura e o acompanhamento de solicitações de suporte.
- O Painel de Indicadores Comerciais reúne indicadores de vendas e desempenho comercial em um único local.
- A Integração SSO do Portal de Benefícios está em rollout e disponível inicialmente para 50% dos colaboradores.

## ❓ FAQ rápido

**O que é SSO?**  
SSO significa login único e permite acessar o Portal de Benefícios utilizando as credenciais corporativas.

**Quem pode utilizar a Integração SSO do Portal de Benefícios?**  
O novo login está disponível inicialmente para 50% dos colaboradores.

**Onde acessar a Central de Solicitações 2.0?**  
Na Intranet → Serviços → Central de Solicitações.
